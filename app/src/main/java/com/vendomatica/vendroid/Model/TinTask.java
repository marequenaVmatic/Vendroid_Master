 ...
 */
public class TinTask {

    public final static String TABLENAME = "tb_tintask";
    ...
    public TinTask(String userid, int taskid, String tasktype, String RutaAbastecimiento, String cus, String nus, String quantity)
    {
        this.userid = userid;
        this.taskid = taskid;
