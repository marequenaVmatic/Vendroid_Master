...
public class DBManager {
	...
	public long insertTickets(ArrayList<Tickets> ListTickets) {
		...
		String listString = gson.toJson(
				ListTickets,
				new TypeToken<ArrayList<Tickets>>() {}.getType());

		ContentValues values = new ContentValues();
		values.put("TableName", "Tickets");
		values.put("ValueTable",listString);
	...
	//insert function about the Ticket Closed class.
	public long insertTicketsCerrados(ArrayList<Tickets> ListTickets) {
		Gson gson = new Gson();
		...
		ContentValues values = new ContentValues();
		values.put("TableName", "TicketsCerrados");
		values.put("ValueTable",listString);
	...
	public ArrayList<Tickets> getAlltickets() {
			SQLiteDatabase db = mDBHelper.getReadableDatabase();
			ArrayList<Tickets> lstTasks = new ArrayList<Tickets>();
			Cursor cursor = db.query("TABLEGENERIC", null,"TableName ='Tickets'", null, null, null, null);
			cursor.moveToFirst();



			try {
				String list = cursor.getString(cursor.getColumnIndex("ValueTable"));
				JSONArray jsonArray =  new JSONArray(list);
				Gson gson = new Gson();
				lstTasks = gson.fromJson(
						list,
						new TypeToken<ArrayList<Tickets>>() {}.getType());
	...
	//delete generic Tickets Closed
	public void deleteAllticketsCerrados() {
		SQLiteDatabase db = mDBHelper.getWritableDatabase();
		db.delete("TABLEGENERIC", "TableName ='TicketsCerrados'", null);
		//db.close();
	}

	//get generic Tickets
	public ArrayList<Tickets> getAllticketsCerrados() {
		SQLiteDatabase db = mDBHelper.getReadableDatabase();
		ArrayList<Tickets> lstTasks = new ArrayList<Tickets>();
		Cursor cursor = db.query("TABLEGENERIC", null,"TableName ='TicketsCerrados'", null, null, null, null);
		cursor.moveToFirst();
